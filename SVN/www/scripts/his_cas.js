// Handler for history page - 'Casuality' section.
...
function showSub2_1(){
    ...
    sub_cat['n9.3'].style.display = 'block';
}
...
document.getElementById('n9.3').onmouseover = onMouse9_3;
document.getElementById('n9.3').onmouseleave = leaveMouse9_3;
...
function onMouse9_3(){
    document.getElementById('n9.3').style.backgroundColor = '#C3073F'

    hover_str = document.getElementsByClassName('date-nor');
    hover_str[2].style.display = "block"
}

function leaveMouse9_3(){
    if (selected_sub == 2) {
        document.getElementById('n9.3').style.backgroundColor = '#C3073F'
    } else {
        document.getElementById('n9.3').style.backgroundColor = '#535353'
